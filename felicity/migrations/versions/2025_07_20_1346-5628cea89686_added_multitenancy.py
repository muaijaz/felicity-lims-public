...
Revision ID: 5628cea89686
Revises: 225f793a73ce
Create Date: 2025-07-20 13:46:06.995969
...
def upgrade():
    ...
    op.add_column('audit_log', sa.Column('laboratory_uid', sa.String(), nullable=False))
    op.create_index(op.f('ix_audit_log_laboratory_uid'), 'audit_log', ['laboratory_uid'], unique=False)
    op.create_foreign_key(None, 'audit_log', 'laboratory', ['laboratory_uid'], ['uid'])
    ...
    op.add_column('date_search_index', sa.Column('laboratory_uid', sa.String(), nullable=False))
    op.create_index(op.f('ix_date_search_index_laboratory_uid'), 'date_search_index', ['laboratory_uid'], unique=False)
    op.create_foreign_key(None, 'date_search_index', 'laboratory', ['laboratory_uid'], ['uid'])
    ...
    op.add_column('group', sa.Column('laboratory_uid', sa.String(), nullable=False))
    ...
    op.add_column('job', sa.Column('laboratory_uid', sa.String(), nullable=False))
    op.create_index(op.f('ix_job_laboratory_uid'), 'job', ['laboratory_uid'], unique=False)
    op.create_foreign_key(None, 'job', 'laboratory', ['laboratory_uid'], ['uid'])
    ...
    op.drop_constraint('message_thread_uid_fkey', 'message', type_='foreignkey')
    ...
    op.add_column('patient_search_index', sa.Column('laboratory_uid', sa.String(), nullable=False))
    op.create_index(op.f('ix_patient_search_index_laboratory_uid'), 'patient_search_index', ['laboratory_uid'], unique=False)
    op.create_foreign_key(None, 'patient_search_index', 'laboratory', ['laboratory_uid'], ['uid'])
    op.add_column('permission', sa.Column('laboratory_uid', sa.String(), nullable=False))
    op.create_index(op.f('ix_permission_laboratory_uid'), 'permission', ['laboratory_uid'], unique=False)
    op.create_foreign_key(None, 'permission', 'laboratory', ['laboratory_uid'], ['uid'])
    op.add_column('permission_groups', sa.Column('laboratory_uid', sa.String(), nullable=False))
    op.create_foreign_key(None, 'permission_groups', 'laboratory', ['laboratory_uid'], ['uid'])
    op.add_column('phone_search_index', sa.Column('laboratory_uid', sa.String(), nullable=False))
    op.create_index(op.f('ix_phone_search_index_laboratory_uid'), 'phone_search_index', ['laboratory_uid'], unique=False)
    op.create_foreign_key(None, 'phone_search_index', 'laboratory', ['laboratory_uid'], ['uid'])
    ...
    op.add_column('report_impress', sa.Column('laboratory_uid', sa.String(), nullable=False))
    op.create_index(op.f('ix_report_impress_laboratory_uid'), 'report_impress', ['laboratory_uid'], unique=False)
    op.create_foreign_key(None, 'report_impress', 'laboratory', ['laboratory_uid'], ['uid'])
    ...
    op.add_column('sms_message', sa.Column('laboratory_uid', sa.String(), nullable=False))
    op.create_index(op.f('ix_sms_message_laboratory_uid'), 'sms_message', ['laboratory_uid'], unique=False)
    op.create_foreign_key(None, 'sms_message', 'laboratory', ['laboratory_uid'], ['uid'])
    op.add_column('sms_template', sa.Column('laboratory_uid', sa.String(), nullable=False))
    op.create_index(op.f('ix_sms_template_laboratory_uid'), 'sms_template', ['laboratory_uid'], unique=False)
    op.create_foreign_key(None, 'sms_template', 'laboratory', ['laboratory_uid'], ['uid'])
    ...
    op.add_column('storage_container', sa.Column('laboratory_uid', sa.String(), nullable=False))
    op.create_index(op.f('ix_storage_container_laboratory_uid'), 'storage_container', ['laboratory_uid'], unique=False)
    op.create_foreign_key(None, 'storage_container', 'laboratory', ['laboratory_uid'], ['uid'])
    op.add_column('storage_location', sa.Column('laboratory_uid', sa.String(), nullable=False))
    op.create_index(op.f('ix_storage_location_laboratory_uid'), 'storage_location', ['laboratory_uid'], unique=False)
    op.create_foreign_key(None, 'storage_location', 'laboratory', ['laboratory_uid'], ['uid'])
    op.add_column('storage_section', sa.Column('laboratory_uid', sa.String(), nullable=False))
    op.create_index(op.f('ix_storage_section_laboratory_uid'), 'storage_section', ['laboratory_uid'], unique=False)
    op.create_foreign_key(None, 'storage_section', 'laboratory', ['laboratory_uid'], ['uid'])
    op.add_column('store_room', sa.Column('laboratory_uid', sa.String(), nullable=False))
    op.create_index(op.f('ix_store_room_laboratory_uid'), 'store_room', ['laboratory_uid'], unique=False)
    op.create_foreign_key(None, 'store_room', 'laboratory', ['laboratory_uid'], ['uid'])
    ...
    op.add_column('user_groups', sa.Column('laboratory_uid', sa.String(), nullable=False))
    ...
    op.add_column('user_preference', sa.Column('organization_uid', sa.String(), nullable=False))
    op.add_column('user_preference', sa.Column('laboratory_uid', sa.String(), nullable=False))
    ...
    op.create_foreign_key(None, 'user_preference', 'organization', ['organization_uid'], ['uid'])
...
def downgrade():
    ...
    op.drop_column('user_preference', 'organization_uid')
    ...
    op.drop_constraint(None, 'store_room', type_='foreignkey')
    op.drop_index(op.f('ix_store_room_laboratory_uid'), table_name='store_room')
    op.drop_column('store_room', 'laboratory_uid')
    op.drop_constraint(None, 'storage_section', type_='foreignkey')
    op.drop_index(op.f('ix_storage_section_laboratory_uid'), table_name='storage_section')
    op.drop_column('storage_section', 'laboratory_uid')
    op.drop_constraint(None, 'storage_location', type_='foreignkey')
    op.drop_index(op.f('ix_storage_location_laboratory_uid'), table_name='storage_location')
    op.drop_column('storage_location', 'laboratory_uid')
    op.drop_constraint(None, 'storage_container', type_='foreignkey')
    op.drop_index(op.f('ix_storage_container_laboratory_uid'), table_name='storage_container')
    op.drop_column('storage_container', 'laboratory_uid')
    ...
    op.drop_constraint(None, 'sms_template', type_='foreignkey')
    op.drop_index(op.f('ix_sms_template_laboratory_uid'), table_name='sms_template')
    op.drop_column('sms_template', 'laboratory_uid')
    op.drop_constraint(None, 'sms_message', type_='foreignkey')
    op.drop_index(op.f('ix_sms_message_laboratory_uid'), table_name='sms_message')
    op.drop_column('sms_message', 'laboratory_uid')
    ...
    op.drop_constraint(None, 'report_impress', type_='foreignkey')
    op.drop_index(op.f('ix_report_impress_laboratory_uid'), table_name='report_impress')
    op.drop_column('report_impress', 'laboratory_uid')
    ...
    op.drop_constraint(None, 'phone_search_index', type_='foreignkey')
    op.drop_index(op.f('ix_phone_search_index_laboratory_uid'), table_name='phone_search_index')
    op.drop_column('phone_search_index', 'laboratory_uid')
    ...
    op.drop_index(op.f('ix_permission_laboratory_uid'), table_name='permission')
    op.drop_column('permission', 'laboratory_uid')
    op.drop_constraint(None, 'patient_search_index', type_='foreignkey')
    op.drop_index(op.f('ix_patient_search_index_laboratory_uid'), table_name='patient_search_index')
    op.drop_column('patient_search_index', 'laboratory_uid')
    ...
    op.add_column('message', sa.Column('thread_uid', sa.VARCHAR(), autoincrement=False, nullable=True))
    op.drop_constraint(None, 'message', type_='foreignkey')
    op.create_foreign_key('message_thread_uid_fkey', 'message', 'message_thread', ['thread_uid'], ['uid'])
    ...
    op.drop_index(op.f('ix_job_laboratory_uid'), table_name='job')
    op.drop_column('job', 'laboratory_uid')
    ...
    op.drop_constraint(None, 'date_search_index', type_='foreignkey')
    op.drop_index(op.f('ix_date_search_index_laboratory_uid'), table_name='date_search_index')
    op.drop_column('date_search_index', 'laboratory_uid')
    ...
    op.drop_index(op.f('ix_audit_log_laboratory_uid'), table_name='audit_log')
    op.drop_column('audit_log', 'laboratory_uid')
